...
struct alignas(16) Mat4 {
    ...
    constexpr float& operator()(size_t row, size_t col) { return data[col * 4 + row]; }
    constexpr float operator()(size_t row, size_t col) const { return data[col * 4 + row]; }
    ...
    static constexpr Mat4 translation(const Vec3& v) { return translation(v.x, v.y, v.z); }
    ...
    static constexpr Mat4 scale(const Vec3& v) { return scale(v.x, v.y, v.z); }

    static constexpr Mat4 scale(float s) { return scale(s, s, s); }
};
