...
public:
    ...
    double octave3D(double x, double y, double z, int octaves, double persistence = 0.5, double lacunarity = 2.0) const;

    // Ridged noise (for caves/ridges)
    double ridged2D(double x, double y, int octaves, double persistence = 0.5, double lacunarity = 2.0) const;
    double ridged3D(double x, double y, double z, int octaves, double persistence = 0.5, double lacunarity = 2.0) const;
