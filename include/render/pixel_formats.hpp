...
//   AO        — single-channel occlusion factor (0..1): R8Unorm is enough for
//               a half-res term that only ever multiplies the scene.
...
inline constexpr MTLPixelFormat AO = MTLPixelFormatR8Unorm;
